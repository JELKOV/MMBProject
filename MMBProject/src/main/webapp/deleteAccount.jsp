                ...
                <div class="row vh-100 bg-light rounded align-items-center justify-content-center mx-0">
                    <div class="col-md-6 text-center">
                        ...
                        <!-- 회원탈퇴 확인 Start -->
	                        ...
	                        <div class="form-floating mb-4" id="deleteForm">
	                            <button type="button" id="delButton" class="btn btn-primary py-3 w-100 mb-4">회원탈퇴</button>
	                        </div>
	                        <!-- 모달창 -->
	                        <div id="myModal" class="modal">
	                        <div class="modal-content">
	                        <span id="close" class="close">&times;</span>
	                        <div class="modal-header"><h4>회원탈퇴 확인</h4></div>
	                        	<div class="modal-body">
	                            <input type="text" class="form-control" id="checkText" placeholder="회원탈퇴 입력">
	                            <label for="checkText" style="white-space:nowrap;">회원탈퇴를 원하시면 "회원탈퇴"를 입력하세요!</label><br>
	                        	</div>
	                        	<div class="modal-footer">
	                            <button type="button" id="deleteButton" class="btn btn-primary py-3 w-100 mb-4" disabled>회원탈퇴</button>
	                        	</div>
	                        </div>
	                        </div>
	                        </div></div></div></div>
