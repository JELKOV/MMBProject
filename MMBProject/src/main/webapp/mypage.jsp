    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
            ...
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="d-flex align-items-center ms-4 mb-4">
                    <div class="position-relative">
                        <img class="rounded-circle" src="${member.memberProfileWay}" alt="img_b/default.png" style="width: 40px; height: 40px;">
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            <img class="rounded-circle" src="${member.memberProfileWay}" alt="사용자 프로필 사진" style="width: 40px; height: 40px;">
        ...
        <div class="profile-header">
            <div class="profile-pic">
                <img src="${member.memberProfileWay}" alt="프로필 사진" id="profileImage">
            </div>
            <div class="profile-info">
                <h2 id="username">${member.memberNickname} </h2>
                <a href="update_profilePage.do"><button class="btn-edit">프로필 수정</button></a>	
                <div>
                <table>
                <tr>
