            ...
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="d-flex align-items-center ms-4 mb-4">
                    ...
                    <div class="ms-3">
                        ...
                        <span>사용자 권한(관리자, user, seller)</span>
                    </div>
                </div>
                <div class="navbar-nav w-100">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="mypage.jsp" class="dropdown-item">내 정보</a>
                            <a href="logout.jsp" class="dropdown-item">로그아웃</a>
                            <a href="delete_account.jsp" class="dropdown-item active">회원탈퇴</a>
                        </div>
                    </div>
                </div>
            </nav>
            ...
            <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            <img class="rounded-circle" src="img_b/default.png" alt="img_b/default.png" style="width: 40px; height: 40px;">
                            <span class="d-none d-lg-inline-flex">사용자 이름</span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-end bg-light border-0 rounded-0 rounded-bottom m-0">
                            <a href="#" class="dropdown-item">내 정보</a>
                            <a href="#" class="dropdown-item">로그아웃</a>
                            <a href="#" class="dropdown-item">회원탈퇴</a>
                        </div>
                    </div>
                </div>
            </nav>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row vh-100 bg-light rounded align-items-center justify-content-center mx-0">
                    <div class="col-md-6 text-center p-4">
                        <i class="bi bi-exclamation-triangle display-1 primary-heading"></i>
                        <h1 class="display-1 fw-bold">404</h1>
                        <h1 class="mb-4">페이지를 찾을 수<br> 없습니다.</h1>
                        <p class="mb-4">죄송합니다.<br> 현재 페이지를 불러오던 중 오류가 발생했거나,<br> 서비스 준비중입니다.</p>
                        <a class="btn btn-primary rounded-pill py-3 px-5" href="mypage.jsp">마이페이지로 돌아가기</a>
                    </div>
                </div>
            </div>
            <!-- 404 End -->
                ...
                <div class="bg-light rounded-top p-4">
                    <div class="row">
                        <div class="col-12 col-sm-6 text-center text-sm-start">
                            &copy; <a href="" class="primary-heading">갈빵질빵</a>, 붕어빵찾아 삼만리. 
                        </div>
