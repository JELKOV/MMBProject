            ...
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                  ...
                  <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="" class="dropdown-item">회원 검색</a>
 </div>
                    </div>
                </div>
            </nav>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>2024-08-15</td>
                <td><a href="newMember.do?num=${PK}}">보기</a></td>
            </tr>
            <tr>
                <td>3</td>
                <td>user03</td>
                ...
                <div class="bg-light rounded-top p-4">
                    <div class="row">
                        <div class="col-12 col-sm-6 text-center text-sm-start">
                            &copy; <a href="controller.jsp?action=MAIN" class="primary-heading">갈빵질빵</a>, 붕어빵찾아 삼만리. 
                        </div>
