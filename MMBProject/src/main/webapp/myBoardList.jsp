        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="product-item bg-white rounded p-3">
                        <img src="https://via.placeholder.com/400x200" alt="Post Image" class="img-fluid rounded mb-3">
                        <h5 class="mb-2">게시글 제목 1</h5>
                        <p class="mb-3">이것은 게시글의 간단한 설명입니다. 더 많은 내용을 보려면 클릭하세요.</p>
