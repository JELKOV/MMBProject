...
public class InsertBoardAction extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String newBoardTitle = request.getParameter("newBoardTitle");					// 게시글 제목
        String newBoardContent = request.getParameter("newBoardContent");				// 게시글 내용
        String secretBoardContents = request.getParameter("secretBoardContents");		// 게시글 공개여부
        String categoryParam = request.getParameter("category");						// 게시글 카테고리
        ...
        // 2. 필수 파라미터 유효성 검사
        // View에서 받아온 값 중 하나라도 null 값이 있다면
